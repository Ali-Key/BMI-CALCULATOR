  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Center(child: Text('BMI Calculators ')),
          centerTitle: true),
            ...
            children: [
              ...
              SliderTheme(
                data: const SliderThemeData(
                    ...
                    overlayColor: Color.fromARGB(255, 253, 106, 106)),
                child: Slider(
                    value: height_value,
                    min: 10,
                    max: 310,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        RawButtons(
                          ...
                          onPressed: () => {setState(() => weight_value++)},
                        )
                      ],
                    )
                  ],
                    ...
                    Row(
                      ...
                      children: [
                        RawButtons(
                          ...
                          onPressed: (() => setState(() =>
                              age_value == 0 ? age_value = 0 : age_value--)),
                        ),
                        const SizedBox(
                          width: 15,
                        ),
